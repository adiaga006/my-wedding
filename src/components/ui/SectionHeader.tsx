...
export default function SectionHeader({ eyebrow, title, ornament = '❧', dark = false, icon, compact = false }: SectionHeaderProps) {
  return (
    <div className={`text-center ${compact ? 'mb-0' : 'mb-10 sm:mb-14 md:mb-16'}`}>
      {icon && (
      ...
      <div className={`divider-ornament ${compact ? 'mt-3' : 'mt-6'}`}>
