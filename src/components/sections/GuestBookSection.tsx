...
function MessageCard({ msg, index }: { msg: GuestMessage; index: number }) {
  return (
    <motion.div
      ...
      className="group relative flex flex-col gap-4 bg-white p-6 sm:p-7 shadow-sm hover:shadow-md transition-shadow duration-300 border-l-2 border-blush hover:border-gold"
    >
      {/* Faint giant quote */}
